...
int main(int argc,char *argv[]){
  ...
  strcat(filename, "./../triangle/poly/twice_four_holes_");
...
void FEM(int n, char *filename, int x, int y){
  ...
  tmp_file_position = "./tmp_data/twice_four_holes_position_data.csv";
  char* tmp_file_size;
  tmp_file_size = "./tmp_data/twice_four_holes_size_data.csv";
