...
int main(int argc,char *argv[]){
  ...
  strcat(filename, "./../triangle/poly/half_one_hole_");
...
void FEM(int n, char *filename, int x, int y){
  ...
  tmp_file_position = "./tmp_data/half_one_hole_position_data.csv";
  char* tmp_file_size;
  tmp_file_size = "./tmp_data/half_one_hole_size_data.csv";
